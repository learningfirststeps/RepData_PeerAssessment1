...
plot1 <- xyplot(as.numeric(tapply(steps, interval, sum)) ~ as.numeric(interval) | weekdayff, data = subset(weekdata, weekdata$weekday == "weekday"), type = "l", xlab = "Interval", ylab = "Number of steps" )

plot2 <- xyplot(as.numeric(tapply(steps, interval, sum)) ~ as.numeric(interval) | weekdayff, data = subset(weekdata, weekdata$weekday == "weekend"), type = "l", xlab = "Interval", ylab = "Number of steps" )
...
##colnames(p_new_weekend) <- c("interval", "avg_steps_weekday", "weekday")
...
##colnames(p_new_weekday) <- c("interval", "avg_steps_weekday", "weekday")
