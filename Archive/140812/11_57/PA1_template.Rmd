...
p_new <- transform(p_new, weekdayff = factor(p_new[,3]))
p_new1 <- p_new[order(p_new[,1], p_new[,3]), ]
...
xyplot(as.numeric(p_new1[,2]) ~ as.numeric(p_new1[,1]) | p_new1$weekday, type = "l", layout = c(1, 2), xlab = "Interval", ylab = "Number of steps" )
