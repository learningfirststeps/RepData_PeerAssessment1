...
ff <- factor (as.POSIXlt(as.Date(restoreddata$date))$wday == 6 | as.POSIXlt(as.Date(restoreddata$date))$wday == 0)

ff <- factor (as.POSIXlt(as.Date(restoreddata$date))$wday, levels = c("weekend", "weekday", "weekday", "weekday", "weekday", "weekday", "weekend"))

ff <- factor ( if (as.POSIXlt(as.Date(restoreddata$date))$wday == 6 | as.POSIXlt(as.Date(restoreddata$date))$wday == 0) "weekend" else "weekday" )
